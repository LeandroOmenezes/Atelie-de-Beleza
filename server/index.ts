...
app.use((req, res, next) => {
  res.setHeader(
    ...
    "default-src 'self'; " +
      ...
      "style-src 'self' 'unsafe-inline' https://fonts.googleapis.com https://cdnjs.cloudflare.com https://*.mercadopago.com; " +
      "img-src 'self' data: blob: https://*.mercadopago.com https://*.mlstatic.com https://images.unsplash.com; " +
      "connect-src 'self' https://api.mercadopago.com https://sdk.mercadopago.com https://*.mercadopago.com https://*.mlstatic.com https://cdnjs.cloudflare.com wss: ws:; " +
